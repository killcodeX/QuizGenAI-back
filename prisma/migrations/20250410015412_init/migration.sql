...
-- CreateIndex
CREATE UNIQUE INDEX "UserFavorite_userId_topicId_key" ON "UserFavorite"("userId", "topicId");
...
-- AddForeignKey
ALTER TABLE "UserFavorite" ADD CONSTRAINT "UserFavorite_topicId_fkey" FOREIGN KEY ("topicId") REFERENCES "Topic"("id") ON DELETE CASCADE ON UPDATE CASCADE;
